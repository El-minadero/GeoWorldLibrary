package net.kevinmendoza.geoworldlibrary.geology.test.object2test;
...
import net.kevinmendoza.geoworldlibrary.geology.test.ObjectParameters2;
...
public class Object2Factory extends AbstractPrototypeFactory {
	
	@Inject
	private ObjectParameters2 parameters;
	...
	static class PrototypeBuilder implements GeologyPrototypeBuilder {
		...
		public GeologyComposite build() { return new Object2(this); }
