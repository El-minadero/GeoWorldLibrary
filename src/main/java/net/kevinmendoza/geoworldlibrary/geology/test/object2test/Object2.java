...
import net.kevinmendoza.geoworldlibrary.geology.test.object2test.Object2Factory.PrototypeBuilder;
...
final class Object2 extends GeologyPrototype {

	public NoiseMap map;
	
	public Object2(PrototypeBuilder builder) {
		super(builder);
		map = builder.getMap();
	}
	...
	protected <T extends GeologyData<T>> T getGeologyData(T t, Vector2i query) {
		if(t.getName().equals(DataFactory.GetEmptySurfaceInstance().getName())) {
			int h = 200;// (int) map.getNoise(query);
