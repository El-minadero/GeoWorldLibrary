...
public class Object2Parameters implements ObjectParameters2 {

	private double ExternalDecay = 2;
	private double InternalDecay = 1;
	
	private double baseOctave = 600;
	private int octaveNumber = 3;
	private int coordinateOffset = 5000;
	...
	private int maxRegionWidth = 700;
	private int minRegionWidth = 200;
	
	public Object2Parameters() {}
