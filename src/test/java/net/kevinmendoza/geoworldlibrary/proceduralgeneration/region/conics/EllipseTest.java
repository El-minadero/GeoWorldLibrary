...
public class EllipseTest {
	...
	public void type() throws Exception {
		...
		out2.add(new Vector2i(4,6));out2.add(new Vector2i(-4,-6));
		edge2.add(new Vector2i(4,0));edge2.add(new Vector2i(0,6));
		
		in3.add(new Vector3i(2,0,0));in3.add(new Vector3i(0,7,0));in3.add(new Vector3i(0,0,2));
		out3.add(new Vector3i(5,0,0));out3.add(new Vector3i(0,0,7));out3.add(new Vector3i(4,0,6));
		out3.add(new Vector3i(-4,0,-6));
		edge3.add(new Vector3i(4,0,0));edge3.add(new Vector3i(-0,0,-6));
	}
	...
	public void isInside_A$Vector2i() throws Exception {
		...
		for(Vector2i vec : in2) {
			...
			assertTrue("Vector " + vec.toString() + " should be inside Conic",actual);
		}
	...
	public void getResidual_A$Vector3i() {
		...
		for(Vector3i vec : in3) {
			residual = target.getResidual(vec);
			expression = (residual<=1);
			assertTrue("residual from inside vector " + vec.toString() + " should be less than 1. is" + residual,expression);
		}
		for(Vector3i vec : out3) {
			residual = target.getResidual(vec);
			expression = (residual>=0);
