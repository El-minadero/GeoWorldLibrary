...
public class RelativeSpace3DTest {
	...
	public void getGlobalPoint_A$Vector2i() throws Exception {
		...
		assertEquals("expected:" + center2i.toString() + ". was" + targetCenter.toString(),
				center2i,targetCenter);
		assertEquals("expected:" + center2i.toString() + ". was" + defaultTargetCenter.toString(),
				center2i,defaultTargetCenter);
		assertEquals(defaultTargetCenter,targetCenter);
		
		assertEquals("expected:" + offrot.toString() + ". was" + targetRot.toString(),
				offrot,targetRot);
	...
	public void getGlobalPoint_A$Vector3i() throws Exception {
		...
		assertEquals("expected:" + center3i.toString() + ". was" + targetCenter.toString(),
				center3i,targetCenter);
		assertEquals("expected:" + center3i.toString() + ". was" + defaultTargetCenter.toString(),
				center3i,defaultTargetCenter);
		assertEquals(defaultTargetCenter,targetCenter);
	...
	public void getLocalPoint_A$Vector2i() throws Exception {
		...
		assertEquals("expected:" + center.toString() + ". was" + localCenter1.toString(),
				center,localCenter1);
		assertEquals("expected:" + center.toString() + ". was" + localCenter2.toString(),
				center,localCenter2);
		assertEquals("expected:" + localoffset.toString() + ". was" + localPoint1.toString(),
				localPoint1,localoffset);
		assertEquals("expected:" + localoffset.toString() + ". was" + localPoint2.toString(),
				localPoint2,localoffset);
	...
	public void getCenter2i_A$() throws Exception {
		...
		assertEquals("expected:" + center2i.toString() + ". was" + centerTarget.toString(),
				center2i,centerTarget);
		assertEquals("expected:" + center2i.toString() + ". was" + defaultCenterTarget.toString(),
				center2i,defaultCenterTarget);
		assertEquals("expected:" + centerTarget.toString() + ". was" + defaultCenterTarget.toString(),
				centerTarget,defaultCenterTarget);
	}
	...
	public void getCenter3i_A$() throws Exception {
		...
		assertEquals("expected:" + center3i.toString() + ". was" + centerTarget.toString(),
				center3i,centerTarget);
		assertEquals("expected:" + center3i.toString() + ". was" + defaultCenterTarget.toString(),
				center3i,defaultCenterTarget);
		assertEquals("expected:" + centerTarget.toString() + ". was" + defaultCenterTarget.toString(),
				centerTarget,defaultCenterTarget);
	}
	...
	public void getDistanceToCenter_A$Vector3i() throws Exception {
		...
		double expected = Math.sqrt( Math.pow(center3i.getX()-testVec.getX(),2) +
				Math.pow(center3i.getZ()-testVec.getZ(),2));
		double test1 = modifier.getDistanceToCenter(testVec);
		double test2 = defaultModifier.getDistanceToCenter(testVec);
		assertTrue("expected:" + expected + ". was" + test1,
				expected-test1 < ZERO);
		assertTrue("expected:" + expected + ". was" + test2,
				expected-test2 < ZERO);
		assertTrue("expected:" + test1 + ". was" + test2,
				test1-test2 < ZERO);
	}
