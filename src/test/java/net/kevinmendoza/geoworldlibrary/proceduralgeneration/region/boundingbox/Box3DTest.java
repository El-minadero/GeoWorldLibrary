...
public class Box3DTest {
	...
	public void type() throws Exception {
		...
		out3.add(new Vector3i(X+1,0,0));out3.add(new Vector3i(0,Y+1,0));out3.add(new Vector3i(0,0,Z+1));
		edge3.add(new Vector3i(X,Y,Z));edge3.add(new Vector3i(-X,-Y,-Z));
	}
	...
	public void isOverYDim_A$Vector3i() throws Exception {
		...
		for(Vector3i vec : in3) {
			...
			assertNotSame("Vector Y dim " + vec.toString() + " should be inside Box :" + target.toString(),actual, expected);
		}
