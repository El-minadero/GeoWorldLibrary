...
public class RectangleConicTest {
	...
	public void type() throws Exception {
		...
		edge2.add(new Vector2i(4,6));edge2.add(new Vector2i(-4,-6));
		
		in3.add(new Vector3i(2,0,0));in3.add(new Vector3i(0,7,0));in3.add(new Vector3i(0,0,2));
		out3.add(new Vector3i(5,0,0));out3.add(new Vector3i(0,0,7));
		edge3.add(new Vector3i(4,0,6));edge3.add(new Vector3i(-4,0,-6));
	}
